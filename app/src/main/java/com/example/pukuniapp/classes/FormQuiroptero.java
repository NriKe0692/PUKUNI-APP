...
public class FormQuiroptero {
    ...
    private float longitud_antebrazo;
    private float longitud_oreja;
    private float longitud_cola;
    private float longitud_tibia;
    private float peso;
    private int indicador_id;
    private String uicn;
    private String cites;
    private String dsn;
    private String libro_rojo;
    private String endemismo;
    private String distribucion_endemismo;
    private String ibas;
    private String ebas;
    ...
    public int getNumero_individuos() {
        return numero_individuos;
    }

    public void setNumero_individuos(int numero_individuos) {
    ...
    public float getLongitud_antebrazo() {
        return longitud_antebrazo;
    }

    public void setLongitud_antebrazo(float longitud_antebrazo) {
        this.longitud_antebrazo = longitud_antebrazo;
    }

    public float getLongitud_oreja() {
        return longitud_oreja;
    }

    public void setLongitud_oreja(float longitud_oreja) {
        this.longitud_oreja = longitud_oreja;
    }

    public float getLongitud_cola() {
        return longitud_cola;
    }

    public void setLongitud_cola(float longitud_cola) {
        this.longitud_cola = longitud_cola;
    }

    public float getLongitud_tibia() {
        return longitud_tibia;
    }

    public void setLongitud_tibia(float longitud_tibia) {
        this.longitud_tibia = longitud_tibia;
    }
    ...
    public String getLibro_rojo() {
        return libro_rojo;
    }

    public void setLibro_rojo(String libro_rojo) {
        this.libro_rojo = libro_rojo;
    }
    ...
    public String getDistribucion_endemismo() {
        return distribucion_endemismo;
    }

    public void setDistribucion_endemismo(String distribucion_endemismo) {
        this.distribucion_endemismo = distribucion_endemismo;
    }

    public String getIbas() {
        return ibas;
    }

    public void setIbas(String ibas) {
        this.ibas = ibas;
    }
    ...
    public void setEbas(String ebas) {
        this.ebas = ebas;
    }
    ...
    public int getEstado_conservacion_id() {
        return estado_conservacion_id;
    }

    public void setEstado_conservacion_id(int estado_conservacion_id) {
