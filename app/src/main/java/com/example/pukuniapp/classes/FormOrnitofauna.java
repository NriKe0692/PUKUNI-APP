...
public class FormOrnitofauna {
    int id;
    int franja_id;
    int temporada_evaluacion_id;
    int estacion_muestreo_id;
    int metodologia_id;
    int unidad_muestreal_id;
    int unidad_vegetacion_id;
    int zona_id;
    float este;
    float norte;
    float altitud;
    ...
    int tipo_registro_id;
    int categoria_abundancia_id;
    int habito_id;
    int grupo_trofico_id;
    int indicador_id;
    float largo_cola;
    float largo_pata;
    ...
    public float getLargo_cola() {
        return largo_cola;
    }

    public void setLargo_cola(float largo_cola) {
        this.largo_cola = largo_cola;
    }

    public float getLargo_pata() {
        return largo_pata;
    }

    public void setLargo_pata(float largo_pata) {
        this.largo_pata = largo_pata;
    }
