...
public class FormRoedor {
    ...
    private float longitud_cuerpo;
    private float longitud_oreja;
    private float longitud_cola;
    private float longitud_pata;
    ...
    public float getLongitud_cuerpo() {
        return longitud_cuerpo;
    }

    public void setLongitud_cuerpo(float longitud_cuerpo) {
        this.longitud_cuerpo = longitud_cuerpo;
    }

    public float getLongitud_pata() {
        return longitud_pata;
    }

    public void setLongitud_pata(float longitud_pata) {
        this.longitud_pata = longitud_pata;
    }
